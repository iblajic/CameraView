...
private extension CameraManager {
    ...
    func updateFrameOrientation() { if UIDevice.current.orientation != .portraitUpsideDown &&  UIDevice.current.orientation != .faceUp &&  UIDevice.current.orientation != .faceDown {
