...
public extension MCameraController {
    ...
    func onImageCaptured(_ action: @escaping (UIImage, CameraPosition) -> ()) -> Self { setAndReturnSelf { $0.config.onImageCaptured = action } }
    ...
    func onOpenLibrary(_ action: @escaping () -> ()) -> Self { setAndReturnSelf { $0.config.onOpenLibrary = action } }
